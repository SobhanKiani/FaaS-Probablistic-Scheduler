...
if __name__ == '__main__':
    ...
    f_cold_start.start_flow_runner(
        iters=iters, store_file_path='./new-results/w2/random/3/cold-start.txt')
    cprint(
    ...
    f_mlp.start_flow_runner(
        iters=iters, store_file_path='./new-results/w2/random/3/mlp.txt')
    ...
    f_all.start_flow_runner(
        iters=iters, store_file_path='./new-results/w2/random/3/warming-all.txt')
    cprint(
    ...
    f_optimal.start_flow_runner(
        iters=iters, store_file_path='./new-results/w2/random/3/optimal.txt')
